...
describe('omnibox redirection', () => {
    ...
    it('should redirect relative uri to localhost', () => {
    ...
    it('should not fail when unknown string is entered', () => {
        assert.equal(omnibox.getResultUrl('Lorizzle nizzle dolor shit amizzle'), undefined);
    });

    it('should redirect dashboard iframe to export uri', () => {
    ...
    describe('jira issue recognizer', () => {
        var expectedUrl = 'https://jira.gooddata.com/jira/browse/GD-123';

        it('should recognize plain numbers as jira issue id', () => {
            assert.equal(omnibox.getResultUrl('123'), expectedUrl);
        });

        it('should recognize prefixed numbers as jira issue id', () => {
            assert.equal(omnibox.getResultUrl('gd-123'), expectedUrl);
        });

        it('should support different projects', () => {
